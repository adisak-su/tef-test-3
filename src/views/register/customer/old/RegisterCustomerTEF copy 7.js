...
const RegisterCustomerTEF = () => {
  ...
  const setHelpers = [
    setHelperText1,setHelperText2,setHelperText3,setHelperText4,setHelperText5,setHelperText6,setHelperText7,setHelperText8,setHelperText9,setHelperText10,setHelperText11,setHelperText12,setHelperText13,setHelperText14,setHelperText15,setHelperText16,setHelperText17,setHelperText18
  ]
  ...
  fieldInputBlock1.forEach((element)=>{fieldInputBlock.push(element)})
  fieldInputBlock2.forEach((element)=>{fieldInputBlock.push(element)})
  fieldInputBlock3.forEach((element)=>{fieldInputBlock.push(element)})
  fieldInputBlock4.forEach((element)=>{fieldInputBlock.push(element)})
